...
from opendraco.models import build_chat, llm_invoke

load_dotenv("opendraco/.env")
...
def gemini_required() -> None:
    ...
    # opendraco venv). The Ollama-only setup is a valid use case -- only fail
    ...
    try:
        ...
        pytest.skip(
            ...
            "run pytest from the opendraco venv or `pip install langchain-google-genai`"
        )
