...
For each file in `opendraco/config/predefined/*.json`, verify the full
...
from opendraco.core.workflow import runner as runner_mod
from opendraco.utils.workspace import Workspace
...
def stubbed_clone(
    ...
    # `runner._run_impl` does `from opendraco.utils.workspace import clone_workspace`
