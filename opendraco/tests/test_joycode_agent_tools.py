"""MCP registration + re-export checks for `opendraco.tools.joycode_agent`.
...
from opendraco.tools.repo.joycode_agent import (
    JOYCODE_AGENT_TOOLS,
    CompleteTool,
...
def test_reexports_resolve() -> None:
    """The 3 symbols re-exported via `opendraco.tools.joycode_agent` are
