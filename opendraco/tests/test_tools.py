...
from opendraco.mcp.server import MCPServer, ToolRegistry, get_server
from opendraco.tools.lint_tools import run_flake8_impl
from opendraco.tools.patch_tools import reset_repo_impl
from opendraco.utils.patch import apply_patch_impl, generate_diff_impl
from opendraco.tools.repo_tools import list_files_impl, read_file_impl
from opendraco.tools.search_tools import search_code_impl
...
def test_agents_share_mcp_singleton() -> None:
    ...
    from opendraco.agents.types import LocatorAgent, PatcherAgent, ReviewerAgent
...
def test_apply_description_fix_resolves_class_one(tmp_path: Path) -> None:
    ...
    from opendraco.tools.patch_tools import apply_description_fix_impl
