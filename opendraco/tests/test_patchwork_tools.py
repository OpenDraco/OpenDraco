"""MCP registration + shape assertions for `opendraco.tools.patchwork`.
...
from opendraco.tools.repo.patchwork.workspace_manifest import workspace_manifest as patchwork_tool
