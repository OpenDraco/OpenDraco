"""MCP registration + behavior checks for `opendraco.tools.trae_agent`.
...
from opendraco.tools.repo.trae_agent import (
    CKGTool,
    JSONEditTool,
    TaskDoneTool,
)
...
def test_local_aggregate_holds_only_trae_specific_tools() -> None:
    ...
    owning bundles in `opendraco/mcp/server.py:default_registry`."""
