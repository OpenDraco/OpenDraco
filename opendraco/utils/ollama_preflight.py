...
Ollama server doesn't have on disk yet. Fail-fast: raises `OpendracoError`
...
def pulled_ollama_models_with_catalog() -> list[dict[str, Any]]:
    ...
    from opendraco.models.ollama_catalog import OLLAMA_CATALOG
    pulled = _list_pulled()
...
def preflight_models(
    ...
    any missing ones. Raises `OpendracoError` on missing binary or non-zero pull.
