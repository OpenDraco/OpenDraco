...
from opendraco.tools.repo.augment_swebench_agent import AUGMENT_SWEBENCH_AGENT_TOOLS
from opendraco.tools.repo.auto_code_rover import AUTO_CODE_ROVER_TOOLS
from opendraco.tools.repo.claude_coder import CLAUDE_CODER_TOOLS
from opendraco.tools.repo.composio import COMPOSIO_TOOLS
from opendraco.tools.repo.debug_gym import DEBUG_GYM_TOOLS
from opendraco.tools.repo.joycode_agent import JOYCODE_AGENT_TOOLS
from opendraco.tools.repo.lingma_swe_gpt import LINGMA_SWE_GPT_TOOLS
from opendraco.tools.repo.openhands import LOC_TOOLS, OPENHANDS_TOOLS
from opendraco.tools.repo.patchwork import PATCHWORK_TOOLS
from opendraco.tools.repo.suna import SUNA_TOOLS
from opendraco.tools.repo.swe_agent import SWE_AGENT_TOOLS
from opendraco.tools.repo.trae_agent import TRAE_AGENT_TOOLS
...
def _discover_tools() -> list[BaseTool]:
    ...
    _scan("opendraco.tools", list(tools_pkg.__path__))
    return out
...
def default_registry() -> ToolRegistry:
    ...
    # Every tool reachable under `opendraco/tools/` — top-level @tool fns
...
def tool_repo_owner_map() -> dict[str, str]:
    """`tool_name -> owner` map. The owner is the `opendraco/tools/<repo>/`
    folder the tool was registered from, or `"opendraco"` for the top-level
    `opendraco/tools/*.py` helpers (apply_patch, read_file, search_code, …).
    ...
    `opendraco tools list --owner X` in the future.
    """
