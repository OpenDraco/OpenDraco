...
from opendraco.config.loader import AgentConfig, agent_config_from_block
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        from opendraco.mcp.server import get_server
        ...
        self.logger: logging.Logger = logging.getLogger(f"opendraco.agents.{self.name}")
