...
The upstream OpenHands `BrowserTool` drives a Playwright session; OpenDraco
...
def BrowserTool(action: str = "", url: str = "") -> str:
    """Stub: this OpenDraco install has no Playwright/Browser runtime.
    ...
    return (
        "error: BrowserTool is not configured in this OpenDraco install "
