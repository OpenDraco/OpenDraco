...
single string. Delegates to `opendraco.tools.patch_tools.apply_patch_impl` so
the patch is applied against the workspace immediately and the registered
behavior matches the rest of the OpenDraco patch tooling.
"""
...
from opendraco.utils.patch import apply_patch_impl
