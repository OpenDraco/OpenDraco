...
The upstream tool prompts the user mid-run for clarification. OpenDraco
...
def askFollowupQuestionTool(question: str) -> str:
    """Stub: OpenDraco runs autonomously, no interactive user channel.
    ...
    return (
        "error: askFollowupQuestionTool is not available in this OpenDraco install "
