...
OpenDraco spawns agents via the **topology graph** (LangGraph edges,
...
def spawnAgentTool(agent_type: str = "", task: str = "") -> str:
    ...
    payload = {
        ...
        "task": task,
        "ok": True,
        "note": "OpenDraco spawns sub-agents via topology edges, not via tool call; this is an advisory signal.",
    }
