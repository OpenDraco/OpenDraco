...
augment canonical so OpenDraco has one consistent completion-marker code
...
from opendraco.tools.repo.augment_swebench_agent.CompleteTool import CompleteTool as _complete
...
def attemptCompletionTool(result: str = "", workspace: str = "", agent: str = "claude_coder") -> str:
    ...
    a `.opendraco/state.json` marker for out-of-process callers."""
