...
`_impl` functions in `opendraco/utils/patch.py`, plus the deterministic class-1
...
`opendraco/utils/patch.py`. This module just wraps each `_impl` in an `@tool`
...
the `_impl` versions from `opendraco/utils/patch` directly.
"""
...
from opendraco.tools.repo_tools import derive_description_fix_impl
from opendraco.tools.search_tools import detect_bug_class_impl
from opendraco.utils.patch import (
    PatchResult,
    _git,
    apply_patch_impl,
    generate_diff_impl,
